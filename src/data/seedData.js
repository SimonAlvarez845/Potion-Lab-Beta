...
const ORIGEN_IMAGENES_DEMO = new URL(import.meta.url).origin;
...
export const USUARIOS_DEMO = [
  {
    ...
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/simon.webp",
    puntos: 180,
    rarezaTotal: 426,
    precisionCatador: 72,
    participacion: 88,
  },
  {
    ...
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/nyra.webp",
    puntos: 240,
    rarezaTotal: 580,
    precisionCatador: 84,
    participacion: 96,
  },
  {
    ...
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/lyrion.webp",
    puntos: 215,
    rarezaTotal: 512,
    precisionCatador: 68,
    participacion: 92,
  ...
  {
    id: "u4",
    nombreCompleto: "David Botero",
    email: "debotero@eia.edu",
    especialidad: "Catador",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/david.webp",
    puntos: 205,
    rarezaTotal: 498,
    precisionCatador: 94,
    participacion: 90,
  },
  {
    ...
    especialidad: "Herbalista",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/mara.webp",
    puntos: 130,
    rarezaTotal: 301,
    precisionCatador: 60,
    participacion: 76,
  },
  {
    ...
    especialidad: "Runista",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/orion.webp",
    puntos: 155,
    rarezaTotal: 344,
    precisionCatador: 64,
    participacion: 81,
  },
  {
    ...
    especialidad: "Catador",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/selene.webp",
    puntos: 192,
    rarezaTotal: 453,
    precisionCatador: 89,
    participacion: 93,
  },
  {
    ...
    especialidad: "Maestro cervecero",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/darian.webp",
    puntos: 170,
    rarezaTotal: 399,
    precisionCatador: 75,
    participacion: 85,
  },
  {
    ...
    especialidad: "Herbalista",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/iria.webp",
    puntos: 118,
    rarezaTotal: 278,
    precisionCatador: 58,
    participacion: 69,
  },
  {
    ...
    especialidad: "Runista",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/eiden.webp",
    puntos: 148,
    rarezaTotal: 332,
    precisionCatador: 70,
    participacion: 79,
  },
  {
    ...
    especialidad: "Catador",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/vera.webp",
    puntos: 102,
    rarezaTotal: 244,
    precisionCatador: 82,
    participacion: 64,
  },
  {
    ...
    especialidad: "Herbalista",
    avatarUrl: ORIGEN_IMAGENES_DEMO + "/demo/nilo.webp",
    puntos: 74,
    rarezaTotal: 182,
    precisionCatador: 49,
    participacion: 24,
...
export const GREMIOS_INICIALES = [
  {
    ...
    emblemaUrl: ORIGEN_IMAGENES_DEMO + "/demo/eclipse.webp",
    acento: "#9b87f5",
    descripcion:
  ...
  },
  {
    ...
    emblemaUrl: ORIGEN_IMAGENES_DEMO + "/demo/boreal.webp",
    acento: "#55d9e8",
    descripcion:
  ...
  },
  {
    ...
    emblemaUrl: ORIGEN_IMAGENES_DEMO + "/demo/umbria.webp",
    acento: "#f4c96b",
    descripcion:
